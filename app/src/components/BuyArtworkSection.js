...
class BuyArtworkSection extends Component {
    render() {
      return ( 
        ...
        <Fragment>
        <p>You will pay <ContractData contract="ArtSteward" method="price" toEth/> ETH.<br /> Add your own sale price and amount you want deposit for covering patronage: </p>
