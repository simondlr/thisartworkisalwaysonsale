...
const contractDir = "./contracts/v1";
const buildDir = "./artifacts/contracts/v1";
...
async function main() {
  ...
  fs.copyFile(buildDir+"/ArtSteward.sol/ArtSteward.json", publishDir+"/ArtSteward.json", (err) => { console.log(err)});
