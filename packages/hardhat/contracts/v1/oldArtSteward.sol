...
// Jan 2021 update:
// This is the same ArtSteward currently in mainnet from March 2019.
// This contract is used only for testing purposes.
// Changes:
// - Bumped version number to 0.7.x
// - IERC721Full -> IERC6721.
// - change now to block.timestamp

contract oldArtSteward {
    ...
    */
    ...
    function patronageOwed() public view returns (uint256 patronageDue) {
        return price.mul(block.timestamp.sub(timeLastCollected)).mul(patronageNumerator)
    ...
    */
    function foreclosureTime() public view returns (uint256) {
        ...
        return block.timestamp + depositAbleToWithdraw().div(pps); // zero division if price is zero.
    }
